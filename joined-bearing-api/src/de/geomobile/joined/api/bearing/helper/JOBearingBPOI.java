 ...
 * 
 */
public class JOBearingBPOI implements Serializable
{
	 ...
	 * 
	 * @param lat
	 *            value of Latitude (12.23233)
	 * @param lon
	 *            value of Longitude (24.87883)
	 * @param description
	 *            name of the PointOfInterest
	 */
	public JOBearingBPOI(double lat, double lon, String description)
	{
		this.lat = lat;
		this.lon = lon;
