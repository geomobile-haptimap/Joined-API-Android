 ...
 */
public class JOFriendFinderServerException extends Exception
{
	 ...
	 */
	public JOFriendFinderServerException()
	{
	 ...
	 */
	public JOFriendFinderServerException(String detailMessage)
	{
		super(detailMessage);
	}
	 ...
	 */
	public JOFriendFinderServerException(Throwable throwable)
	{
		super(throwable);
	}
	 ...
	 * @param throwable The exception basis.
	 */
	public JOFriendFinderServerException(String detailMessage, Throwable throwable)
	{
