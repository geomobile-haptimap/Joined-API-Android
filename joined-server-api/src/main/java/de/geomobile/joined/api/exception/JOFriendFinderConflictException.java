 ...
 */
public class JOFriendFinderConflictException extends Exception
{
	private static final long serialVersionUID = 6236680387785099374L;

	/**
	 * Constructs an exception with no detail message.
	 */
	public JOFriendFinderConflictException()
	{
	 ...
	 */
	public JOFriendFinderConflictException(String detailMessage)
	{
		super(detailMessage);
	}
	 ...
	 */
	public JOFriendFinderConflictException(Throwable throwable)
	{
		super(throwable);
	}
	 ...
	 * @param throwable The exception basis.
	 */
	public JOFriendFinderConflictException(String detailMessage, Throwable throwable)
	{
