 ...
 */
public class FriendFinderServerException extends Exception
{
	 ...
	 */
	public FriendFinderServerException()
	{
	 ...
	 */
	public FriendFinderServerException(String detailMessage)
	{
		super(detailMessage);
	}
	 ...
	 */
	public FriendFinderServerException(Throwable throwable)
	{
		super(throwable);
	}
	 ...
	 * @param throwable The exception basis.
	 */
	public FriendFinderServerException(String detailMessage, Throwable throwable)
	{
