 ...
 */
public class FriendFinderLoginException extends Exception
{
	 ...
	 */
	public FriendFinderLoginException()
	{
	 ...
	 */
	public FriendFinderLoginException(String detailMessage)
	{
		super(detailMessage);
	}
	 ...
	 */
	public FriendFinderLoginException(Throwable throwable)
	{
		super(throwable);
	}
	 ...
	 * @param throwable The exception basis.
	 */
	public FriendFinderLoginException(String detailMessage, Throwable throwable)
	{
