 ...
 */
public class FriendFinderSourceException extends Exception
{
	 ...
	 */
	public FriendFinderSourceException()
	{
	 ...
	 */
	public FriendFinderSourceException(String detailMessage)
	{
		super(detailMessage);
	}
	 ...
	 */
	public FriendFinderSourceException(Throwable throwable)
	{
		super(throwable);
	}
	 ...
	 * @param throwable The exception basis.
	 */
	public FriendFinderSourceException(String detailMessage, Throwable throwable)
	{
