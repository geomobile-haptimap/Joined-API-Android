 ...
 */
public class FriendFinderConflictException extends Exception
{
	 ...
	 */
	public FriendFinderConflictException(Throwable throwable)
	{
		super(throwable);
	}
	 ...
	 * @param throwable The exception basis.
	 */
	public FriendFinderConflictException(String detailMessage, Throwable throwable)
	{
