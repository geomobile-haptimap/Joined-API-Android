 ...
 */
public class JORegisterTest extends TestCase
{
	/**
	...
	public void test()
	{
		try
		{
			...
			JOUser user2 = client.register(JOConfig.TEST_USER_2, JOConfig.TEST_USER_2);
		...
		catch (JOFriendFinderConflictException e)
		{
			e.printStackTrace();
			assertTrue(false);
		}
